        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <div className="flex gap-3 px-6 py-4 font-normal text-gray-900">
            ...
            <div className="text-sm">
              <div className="font-medium text-gray-700"> Нямбаатар</div>
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <Link onClick={logout} href={""} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
